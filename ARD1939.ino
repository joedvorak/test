...
void loop()
{
  ...
  byte msgShort[] = {0x01, 0x02, 0x03, 0x04, 0x05,0x06,0x07,0x08};
  ...
  */
  ...
  if(nJ1939Status == NORMALDATATRAFFIC)
  {
    ...
    if(nCounter == (int)(500/SYSTEM_TIME))
    {
      eng_RPM++;
      nSrcAddr = j1939.GetSourceAddress();
      ...
      Serial.print(eng_RPM);
      Serial.print("\tmsgShort[3] = ");
      Serial.print(msgShort[3]);
      Serial.print("\tmsgShort[4] = ");
      Serial.println(msgShort[4]);
    }// end if
